...
const UploadFile = () => {
    ...
    return (
        <>
            <img className='upload-icon' src='/upload-file.png' alt='upload icon' width={100} height={95} onClick={handleUpload} />
            ...
            <label className='upload'>
                ...
                <img src='/file.png' alt='file upload icon' width={24} height={24} /><span className='upload-browse-msg'>Parcourir les fichiers</span>
            </label>
